        ...
        <el-table-column label="操作" fixed="right" width="360">
          <template #default="{ row }">
            <div style="display: flex; flex-wrap: wrap; gap: 4px;">
              ...
              <!-- 审批（已复核） -->
              <el-button v-if="row.status === 'reviewed'" link type="success" @click="finalApproveOrder(row)">审批</el-button>
              <!-- 收货（已审批） -->
              <el-button v-if="row.status === 'final_approved'" link type="success" @click="receiveOrder(row)">收货</el-button>
              <!-- 检验（已收货） -->
