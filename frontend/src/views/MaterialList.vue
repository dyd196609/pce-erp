    ...
    <div style="overflow-x: auto; width: 100%">
      ...
      >
          ...
          <template #header>
            <div class="filter-header">
              ...
              <el-input 
                ...
                size="small"
                clearable
                @input="handleTextFilter('code', codeFilterText)"
                class="filter-input"
              />
            </div>
          </template>
          ...
          <template #header>
            <div class="filter-header">
              ...
              <el-input 
                ...
                size="small"
                clearable
                @input="handleTextFilter('name', nameFilterText)"
                class="filter-input"
              />
            </div>
          </template>
          ...
          <template #header>
            <div class="filter-header">
              ...
              <el-input 
                ...
                size="small"
                clearable
                @input="handleTextFilter('specification', specFilterText)"
                class="filter-input"
              />
            </div>
          </template>
        ...
        >
          <template #header>
            <div class="filter-header">
              <span>单位</span>
              <el-input 
                v-model="unitFilterText" 
                placeholder="筛选" 
                size="small"
                clearable
                @input="handleTextFilter('unit', unitFilterText)"
                class="filter-input"
              />
            </div>
          </template>
        ...
        >
          <template #header>
            <div class="filter-header">
              <span>物料类型</span>
              <el-select 
                v-model="materialTypeFilterText" 
                placeholder="筛选" 
                size="small"
                clearable
                @change="handleSelectFilter('material_type', materialTypeFilterText)"
                class="filter-input"
              >
          ...
          <template #header>
            <div class="filter-header">
              ...
              <el-select 
                ...
                clearable
                filterable
                @change="handleSelectFilter('category_name', categoryFilterText)"
                class="filter-input"
              >
                <el-option 
        ...
        >
          <template #header>
            <div class="filter-header">
              <span>安全库存</span>
              <el-input 
                v-model="safetyStockFilterText" 
                placeholder="筛选" 
                size="small"
                clearable
                @input="handleNumberFilter('safety_stock', safetyStockFilterText)"
                class="filter-input"
              />
            </div>
          </template>
        ...
        >
          <template #header>
            <div class="filter-header">
              <span>最高库存</span>
              <el-input 
                v-model="maxStockFilterText" 
                placeholder="筛选" 
                size="small"
                clearable
                @input="handleNumberFilter('max_stock', maxStockFilterText)"
                class="filter-input"
              />
            </div>
          </template>
        ...
        >
          <template #header>
            <div class="filter-header">
              <span>补货点</span>
              <el-input 
                v-model="reorderPointFilterText" 
                placeholder="筛选" 
                size="small"
                clearable
                @input="handleNumberFilter('reorder_point', reorderPointFilterText)"
                class="filter-input"
              />
            </div>
          </template>
        ...
        <el-table-column 
          label="采购件" 
          width="80"
          column-key="is_purchased"
        >
          <template #header>
            <div class="filter-header">
              <span>采购件</span>
              <el-select 
                v-model="isPurchasedFilterText" 
                placeholder="筛选" 
                size="small"
                clearable
                @change="handleSelectFilter('is_purchased', isPurchasedFilterText)"
                class="filter-input"
              >
        ...
        <el-table-column 
          label="生产件" 
          width="80"
          column-key="is_produced"
        >
          <template #header>
            <div class="filter-header">
              <span>生产件</span>
              <el-select 
                v-model="isProducedFilterText" 
                placeholder="筛选" 
                size="small"
                clearable
                @change="handleSelectFilter('is_produced', isProducedFilterText)"
                class="filter-input"
              >
                <el-option label="是" :value="true" />
                <el-option label="否" :value="false" />
        ...
        >
          <template #header>
            <div class="filter-header">
              <span>标准成本</span>
              <el-input 
                v-model="standardCostFilterText" 
                placeholder="筛选" 
                size="small"
                clearable
                @input="handleNumberFilter('standard_cost', standardCostFilterText)"
                class="filter-input"
              />
            </div>
          </template>
          ...
          <template #header>
            <div class="filter-header">
              ...
              <el-select 
                ...
                size="small"
                clearable
                @change="handleSelectFilter('is_active', statusFilterText)"
                class="filter-input"
              >
...
const loadMaterials = async () => {
  try {
    ...
    const res = await request.get('/masterdata/materials/', { params });
...
const submitForm = async () => {
  ...
  try {
    ...
    if (form.value.id) {
      ...
      await request.post('/masterdata/materials/', data);
